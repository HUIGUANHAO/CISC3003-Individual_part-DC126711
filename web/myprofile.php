...
<body>
    ...
    <header class="head" id="head">
        ...
        <div class="nav_box">
            ...
            <a href="myorder.php"><span class="oder_title">MY ORDER</span></a>
        </div>
        ...
        ?>  
        <div class="photo">
            <a href="myprofile.php"><img src="photo.png" alt="some_text" width="50" height="50" style="border-radius: 50%;margin-top: 25px;margin-left: 122px;"></a>     
        </div>
        <?php
            }
        ?>
    ...
    <form action="../PHP/ten_postInfo.php" method="post">
        ...
        ?>
        <div>
            <img src="<?php echo $info['tn_photo'] ?>" alt="some_text" width="100" height="100" style="border-radius: 50%;margin-top: -90px; margin-left: 180px;">
        </div>
        <?php
            }
            else{
        ...
        <div class="name_box">
            <p class="name_text">USER NAME</p>
                <input type="text" name="username" readonly value="<?php echo $info['tn_name']?>" style="height: 28px; margin-left: 90px;margin-top: 10px;">
        </div>
        <!-- GENDER -->
        <div class="sex_box">
            <p class="sex_text">GENDER</p>
                <input name="sex" type="radio" value="男" <?php if($info['tn_sex'] == '男'){?> checked <?php }?> style="margin-top: 5px;margin-left: 90px;"/><label>MALE&nbsp;&nbsp;</label>
                <input name="sex" type="radio" value="女" <?php if($info['tn_sex'] == '女'){?> checked <?php }?>/><label>FEMALE</label>
        </div>
        <!-- PHONE NUMBER -->
        <div class="phonenumber_box">
            <p class="phonenumber_text">PHONE NUMBER</p>
                <input type="text" name="phone" value="<?php echo $info['tn_phonenum']?>" style="height: 28px; margin-left: 74px;margin-top: 10px;">
        </div>
        <!-- EMAIL -->
        <div class="email_box">
            <p class="email_text">EMAIL</p>
            <input type="email" name="email" value="<?php echo $info['tn_email']?>" 
                        style="height: 28px; margin-left: 90px;margin-top: 10px;">
        </div>
        <!-- location -->
        <div class="address_box">
            <p class="address_text">LOCATION</p>
                <input type="text" name="address"  value="<?php echo $info['tn_address']?>" 
